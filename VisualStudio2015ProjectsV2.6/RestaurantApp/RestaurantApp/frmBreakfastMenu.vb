Public Class frmBreakfastMenu
    Private Sub frmMainMenu_Click(sender As Object, e As EventArgs)
        frmMainMenu.Show()
    End Sub

    Private Sub frmBreakfastMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
